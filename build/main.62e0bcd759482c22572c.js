...
"use strict";
/* WEBPACK VAR INJECTION */(function(__dirname) { // deps
...
const {
  exec,
  spawn
} = __webpack_require__(/*! child_process */ "child_process"); // const parseVoicesEspeak = require(join(__dirname, "parseVoicesEspeak.js"));
...
const parseVoicesEspeak = __webpack_require__(/*! ./parseVoicesEspeak.js */ "./simpletts/lib/parseVoicesEspeak.js");

const parseVoicesSAPI = __webpack_require__(/*! ./parseVoicesSAPI.js */ "./simpletts/lib/parseVoicesSAPI.js");

const readOptionsToEspeakArgs = __webpack_require__(/*! ./readOptionsToEspeakArgs.js */ "./simpletts/lib/readOptionsToEspeakArgs.js");

const readOptionsToSAPIArgs = __webpack_require__(/*! ./readOptionsToSAPIArgs.js */ "./simpletts/lib/readOptionsToSAPIArgs.js"); // consts


const IS_WINDOWS = "win32" === __webpack_require__(/*! os */ "os").platform().trim().toLowerCase();

const CSCRIPT_ARGS = ["//NoLogo", "//B"];
const LISTVOICES = join(__dirname, "..", "batchs", "listvoices.vbs");
const PLAYTEXT = join(__dirname, "..", "batchs", "playtext.vbs"); // module
...
module.exports = class {
  ...
  getVoices() {
    ...
    return new Promise((resolve, reject) => {
      exec(IS_SAPI ? "cscript " + CSCRIPT_ARGS.join(" ") + " \"" + LISTVOICES + "\"" : "espeak --voices", (err, _stdout, stderr) => {
        if (err) {
          reject(stderr);
        } else {
          const stdout = _stdout.trim().replace(/\r/g, "\n").replace(/\n\n/g, "\n").split("\n");

          resolve(IS_SAPI ? parseVoicesSAPI(stdout.slice(1, stdout.length), stdout) : parseVoicesEspeak(stdout.slice(1, stdout.length)));
        }
      }); // standardise
    }).then(voices => {
      const result = [];
  ...
  read(_options) {
    ...
    if ("undefined" === typeof _options) {
      ...
      const options = "string" === typeof _options ? {
        "text": _options
      } : _options;
      ...
      if ("undefined" === typeof options.text) {
        ...
        this._readPromise = Promise.resolve().then(() => {
          return this.defaultVoice ? Promise.resolve(this.defaultVoice) : this.getVoices().then(voices => {
            this.defaultVoice = voices.shift();
          ...
          return this._forceStop ? Promise.resolve(options) : Promise.resolve().then(() => {
            const args = IS_SAPI ? readOptionsToSAPIArgs(options) : readOptionsToEspeakArgs(options);
            args.push(options.text);
            return Promise.resolve(args);
          }).then(args => {
            return new Promise((resolve, reject) => {
              this._reader = IS_SAPI ? spawn("cscript", CSCRIPT_ARGS.concat([PLAYTEXT]).concat(args)) : spawn("espeak", args);
              let err = "";
...
/***/ "./simpletts/lib/parseVoicesEspeak.js":
/*!********************************************!*\
  !*** ./simpletts/lib/parseVoicesEspeak.js ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./simpletts/lib/parseVoicesSAPI.js":
/*!******************************************!*\
  !*** ./simpletts/lib/parseVoicesSAPI.js ***!
  \******************************************/
/*! no static exports found */
...
/***/ "./simpletts/lib/readOptionsToEspeakArgs.js":
/*!**************************************************!*\
  !*** ./simpletts/lib/readOptionsToEspeakArgs.js ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = options => {
  ...
  return [// 0 -> 200
  "-a", options.volume * 2, // 80 -> 240
  "-s", Math.round(speed + 80), "-v", "string" === typeof options.voice ? options.voice : options.voice.name];
};

/***/ }),

/***/ "./simpletts/lib/readOptionsToSAPIArgs.js":
/*!************************************************!*\
  !*** ./simpletts/lib/readOptionsToSAPIArgs.js ***!
  \************************************************/
/*! no static exports found */
...
module.exports = options => {
  return [// 0 -> 100
  "-v", options.volume, // -10 -> 10
  "-r", Math.round(options.speed / 5) - 10, "-voice", "string" === typeof options.voice ? options.voice : options.voice.name];
};
...
/* harmony import */ var _simpletts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../simpletts */ "./simpletts/lib/main.js");
/* harmony import */ var _simpletts__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_simpletts__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash/debounce */ "./node_modules/lodash/debounce.js");
/* harmony import */ var lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash_debounce__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_audioHeader_audioHeader_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/audioHeader/audioHeader.js */ "./src/components/audioHeader/audioHeader.js");
/* harmony import */ var _components_textList_textList_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/textList/textList.js */ "./src/components/textList/textList.js");
...
var tts;
var speechIntervalList = [];
var speechStartDelayList = [];
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clearAudio", function () {
      speechStartDelayList.forEach(function (item) {
        return clearTimeout(item);
      });
      speechIntervalList.forEach(function (item) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "playButtonClicked", function () {
      _this.clearAudio();

      if (!_this.state.isPlaying) {
        _this.state.data.forEach(function (speech) {
          if (speech.enabled) {
            speechStartDelayList.push(setTimeout(function () {
              tts.read({
                text: speech.text,
                voice: {
                  gender: "male",
              ...
              speechIntervalList.push(setInterval(function () {
                tts.read({
                  text: speech.text,
                  voice: {
                    gender: "male",
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addSpeech", function (text) {
      var newSpeech = {
        id: Date.now(),
        enabled: true,
        text: text,
      ...
      _this.setState(function (state) {
        var newData = _toConsumableArray(state.data).concat([newSpeech]);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onStartDelayChange", lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()(function (id, startDelay) {
      _this.setState(function (state) {
        var newData = state.data.map(function (speech) {
          if (speech.id === id) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onIntervalChange", function (id, interval) {
      _this.setState(function (state) {
        var newData = state.data.map(function (speech, index) {
          if (speech.id === id) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSpeedChange", function (id, speed) {
      _this.setState(function (state) {
        var newData = state.data.map(function (speech, index) {
          if (speech.id === id) {
            speech.speed = speed;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onVolumeChange", function (id, volume) {
      _this.setState(function (state) {
        var newData = state.data.map(function (speech, index) {
          if (speech.id === id) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onEnabledChange", function (id, enabled) {
      _this.setState(function (state) {
        var newData = state.data.map(function (speech, index) {
          if (speech.id === id) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "deleteSpeech", function (id) {
      _this.setState(function (state) {
        var newData = state.data.filter(function (speech) {
          return speech.id !== id;
        });
        localStorage.setItem("speechData", JSON.stringify(newData));
        return {
    ...
    if (!tts) {
      tts = new _simpletts__WEBPACK_IMPORTED_MODULE_3___default.a();
    }

    _this.state.data = JSON.parse(localStorage.getItem("speechData") || "[]");
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_audioHeader_audioHeader_js__WEBPACK_IMPORTED_MODULE_5__["default"], {
        isPlaying: this.state.isPlaying,
        playButtonClicked: this.playButtonClicked,
        clearAudio: this.clearAudio
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_textList_textList_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        speechList: this.state.data,
        addSpeech: this.addSpeech,
        action: {
          onStartDelayChange: this.onStartDelayChange,
...
/***/ "./src/components/addSpeech/addSpeech.css":
/*!************************************************!*\
  !*** ./src/components/addSpeech/addSpeech.css ***!
  \************************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"addSpeechContainer":"_1-meM6MiWvyXcDnailRf0X","openButton":"_3LCqHQ8DIiNTEuXSAFaDZp","newSpeechInput":"_3gG8vsb9qvHEiPCu46Crgz","showInput":"tB7svTp1W58NrJB6YlI05"};

/***/ }),

/***/ "./src/components/addSpeech/addSpeech.js":
/*!***********************************************!*\
  !*** ./src/components/addSpeech/addSpeech.js ***!
  \***********************************************/
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _addSpeech_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addSpeech.css */ "./src/components/addSpeech/addSpeech.css");
/* harmony import */ var _addSpeech_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_addSpeech_css__WEBPACK_IMPORTED_MODULE_1__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(AddSpeech, _React$Component);
  ...
  function AddSpeech() {
    ...
    _classCallCheck(this, AddSpeech);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AddSpeech)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "newSpeechInit", function () {
      _this.setState(function (state, props) {
        return {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onNewSpeechChange", function (event) {
      _this.setState({
        newSpeechText: event.target.value
      });
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "enterKeyListener", function (event) {
      if (event.keyCode === 13 && _this.state.newSpeechText !== "") {
        _this.props.addSpeech(_this.state.newSpeechText);
  ...
  _createClass(AddSpeech, [{
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: _addSpeech_css__WEBPACK_IMPORTED_MODULE_1___default.a.addSpeechContainer
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        onClick: this.newSpeechInit,
        className: _addSpeech_css__WEBPACK_IMPORTED_MODULE_1___default.a.openButton
      }, "+"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
        className: "".concat(_addSpeech_css__WEBPACK_IMPORTED_MODULE_1___default.a.newSpeechInput, " ").concat(this.state.showInput && _addSpeech_css__WEBPACK_IMPORTED_MODULE_1___default.a.showInput),
        value: this.state.newSpeechText,
        onChange: this.onNewSpeechChange,
        onKeyUp: this.enterKeyListener
      }));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (AddSpeech);

/***/ }),

/***/ "./src/components/audioHeader/audioHeader.css":
/*!****************************************************!*\
  !*** ./src/components/audioHeader/audioHeader.css ***!
  \****************************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"audioHeader":"_19TC-mrVY8eb9nVPJUZKAp","playButton":"_1_xvMhMmeJKOwxE-HIds-G","playing":"_1IoXYNKw1VjNzbXFKZkNYS","clearButton":"_2A7ygUQu0TLI3NvOLUvGo7","devtoolsButton":"_1IIPiQgXWaqBcPV-Vo1dD7"};

/***/ }),

/***/ "./src/components/audioHeader/audioHeader.js":
/*!***************************************************!*\
  !*** ./src/components/audioHeader/audioHeader.js ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony import */ var _audioHeader_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./audioHeader.css */ "./src/components/audioHeader/audioHeader.css");
/* harmony import */ var _audioHeader_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_audioHeader_css__WEBPACK_IMPORTED_MODULE_2__);




var AudioHeader = function AudioHeader(props) {
  var remote = electron__WEBPACK_IMPORTED_MODULE_1__["remote"];
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _audioHeader_css__WEBPACK_IMPORTED_MODULE_2___default.a.audioHeader
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    type: "button",
    className: "".concat(_audioHeader_css__WEBPACK_IMPORTED_MODULE_2___default.a.playButton, " ").concat(props.isPlaying && _audioHeader_css__WEBPACK_IMPORTED_MODULE_2___default.a.playing),
    onClick: props.playButtonClicked
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    type: "button",
    className: _audioHeader_css__WEBPACK_IMPORTED_MODULE_2___default.a.clearButton,
    onClick: props.clearAudio
  }, "Clear"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    type: "button",
    className: _audioHeader_css__WEBPACK_IMPORTED_MODULE_2___default.a.devtoolsButton,
    onClick: function onClick() {
      return remote.getCurrentWebContents().openDevTools({
        mode: 'bottom'
      });
    }
  }, "Devtools"));
...
/* harmony default export */ __webpack_exports__["default"] = (AudioHeader);

/***/ }),

/***/ "./src/components/speech/speech.css":
/*!******************************************!*\
  !*** ./src/components/speech/speech.css ***!
  \******************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"speechItem":"_4-tnXwblVNIm72AKWlTix","item_status":"_2Zll3y6WaN4k6EgZDjTdNh","itemStatus":"_2Zll3y6WaN4k6EgZDjTdNh","item_text":"_2m4s3QZC89myb35u5pYF_G","itemText":"_2m4s3QZC89myb35u5pYF_G","item_start_delay":"_3yb3N0uywHCXqZ9VCnkyK5","itemStartDelay":"_3yb3N0uywHCXqZ9VCnkyK5","item_interval":"_1Y28X_2JJGWmnH2aMsKNnk","itemInterval":"_1Y28X_2JJGWmnH2aMsKNnk","item_speed":"_323KZ7pT5WUlgWuNtEAp_5","itemSpeed":"_323KZ7pT5WUlgWuNtEAp_5","item_volume":"_2gsX3ajc734suQ0nIula-l","itemVolume":"_2gsX3ajc734suQ0nIula-l","item_delete":"_1m5VoJSgXsF7f-t2ezRYzF","itemDelete":"_1m5VoJSgXsF7f-t2ezRYzF","item_delete_button":"_2DeDoXjMfIyeMTuuwoN-9Z","itemDeleteButton":"_2DeDoXjMfIyeMTuuwoN-9Z"};

/***/ }),

/***/ "./src/components/speech/speech.js":
/*!*****************************************!*\
  !*** ./src/components/speech/speech.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _speech_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./speech.css */ "./src/components/speech/speech.css");
/* harmony import */ var _speech_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_speech_css__WEBPACK_IMPORTED_MODULE_1__);



var Speech = function Speech(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.speechItem
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_status
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "checkbox",
    checked: props.speech.enabled,
    onChange: function onChange(event) {
      return props.action.onEnabledChange(props.speech.id, event.target.checked);
    }
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_text
  }, props.speech.text), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_start_delay
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Start delay"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    value: props.speech.startDelay,
    onChange: function onChange(event) {
      return props.action.onStartDelayChange(props.speech.id, event.target.value);
    }
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_interval
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Interval"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    value: props.speech.interval,
    onChange: function onChange(event) {
      return props.action.onIntervalChange(props.speech.id, event.target.value);
    }
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_speed
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Speed"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    value: props.speech.speed,
    onChange: function onChange(event) {
      return props.action.onSpeedChange(props.speech.id, event.target.value);
    }
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_volume
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Volume"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    value: props.speech.volume,
    onChange: function onChange(event) {
      return props.action.onVolumeChange(props.speech.id, event.target.value);
    }
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_delete
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    type: "button",
    className: _speech_css__WEBPACK_IMPORTED_MODULE_1___default.a.item_delete_button,
    onClick: function onClick() {
      return props.action.deleteSpeech(props.speech.id);
    }
  }, "X")));
};
...
/***/ "./src/components/textList/textList.css":
/*!**********************************************!*\
  !*** ./src/components/textList/textList.css ***!
  \**********************************************/
/*! no static exports found */
...
// extracted by mini-css-extract-plugin
module.exports = {"textList":"_21h_GMhbZtZ1rl3CJarscB"};

/***/ }),

/***/ "./src/components/textList/textList.js":
/*!*********************************************!*\
  !*** ./src/components/textList/textList.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _speech_speech_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../speech/speech.js */ "./src/components/speech/speech.js");
/* harmony import */ var _addSpeech_addSpeech_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../addSpeech/addSpeech.js */ "./src/components/addSpeech/addSpeech.js");
/* harmony import */ var _textList_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./textList.css */ "./src/components/textList/textList.css");
...
var TextList = function TextList(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: _textList_css__WEBPACK_IMPORTED_MODULE_3___default.a.textList
  }, props.speechList.map(function (speech) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_speech_speech_js__WEBPACK_IMPORTED_MODULE_1__["default"], {
      key: speech.id,
      speech: speech,
      action: props.action
    });
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_addSpeech_addSpeech_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
    addSpeech: props.addSpeech
  }));
};
...
/******/ });
//# sourceMappingURL=main.62e0bcd759482c22572c.js.map